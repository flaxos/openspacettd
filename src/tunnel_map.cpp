...
{
	return IsTunnelInWayDir(tile, z, (TileX(tile) > (Map::MaxX() / 2)) ? DiagDirection::NE : DiagDirection::SW) ||
			IsTunnelInWayDir(tile, z, (TileY(tile) > (Map::MaxY() / 2)) ? DiagDirection::NW : DiagDirection::SE);
}
