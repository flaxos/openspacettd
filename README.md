...
> This repository is the OpenSpaceTTD fork. Current delivery work starts with the [recovery plan](docs/RECOVERY_PLAN_2026-09-15.md). See the [OpenSpaceTTD project status and roadmap](docs/PROJECT_STATUS_AND_ROADMAP.md); the remainder of this README retains the upstream OpenTTD overview and build information.
