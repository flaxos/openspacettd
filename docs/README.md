...
- [Project status and roadmap](PROJECT_STATUS_AND_ROADMAP.md) — completed spikes and sprints, incomplete goals and planned Sprints 35–38.
...
`PORTAL_WORMHOLE_SPIKE.md`, `SPRINT23_SCOPE_ART_AND_UAT_AUDIT_2026-09-13.md` and superseded roadmap sections record earlier decisions. Generic OpenTTD documents in this directory remain upstream technical references and do not state OpenSpaceTTD feature status.
