...
function OpenSpaceUATDemo::Start()
{
	if (!this.initialized) {
		...
		local tutorial_hub_text = "TUTORIAL INSTRUCTIONS: Open Corporate Headquarters > 'Planetary Stockpiles' tab and verify multi-world inventory levels across all 6 fabrication roles. Inspect the Merredin Planetary Logistics Hub on World 2, configure minimum reserve floors, and verify train stockpile ingestion.";
